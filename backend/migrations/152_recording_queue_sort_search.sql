-- ============================================================================
-- 152_recording_queue_sort_search.sql
-- Recording-review queue: add column sorting (p_sort + p_dir, whitelisted) and
-- broaden the free-text search to "search anything" (customer, phone, closer
-- name, company, product/plan, reference, lead code, and sale id).
-- Replaces the 151 signature. Apply AFTER 150 + 151. Idempotent.
-- ============================================================================
...
DECLARE
  ...
  v_dir  text;
BEGIN
  -- whitelist the sort column → a safe source expression (no user SQL injected)
