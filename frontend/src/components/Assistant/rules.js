...
const SECTION_HELP = {
  ...
  closer_assigned: "Assigned Transfers: leads handed to you to work. Open one, call the customer, set a disposition — then log the deal under My Sales. Paginated, so page through your queue.",
  team_transfers: "Team Transfers: every transfer your team created. Filter by status/date/agent; click a row for detail.",
  team_callbacks: "Team Callbacks: your whole team's scheduled callbacks + who's overdue. Use it to make sure nothing slips.",
  tracked_numbers: "Tracked Numbers: phone-number call history + ownership for your team.",
