              ...
              <tbody>
                {entries.map(e => (
                  <tr key={e.id} style={{ borderBottom: '1px solid var(--color-border)' }}>
                    <td className="px-3 py-1.5 text-xs whitespace-nowrap" style={{ color: 'var(--color-text-secondary)' }}>{fmtDateTime(e.created_at)}</td>
                    <td className="px-3 py-1.5 text-xs" style={{ color: 'var(--color-text)' }}>{e.actor_name || '—'}</td>
                    ...
                    <td className="px-3 py-1.5 text-xs max-w-xs truncate" style={{ color: 'var(--color-text-secondary)' }}>{e.notes || '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
                ...
                <tbody>
                  {sorted.map(c => (
                    <tr key={c.id} className="cursor-pointer"
                      ...
                      <td className="px-3 py-1.5 text-xs whitespace-nowrap" style={{ color: 'var(--color-text-secondary)' }}>
                      ...
                      <td className="px-3 py-1.5 text-xs" style={{ color: 'var(--color-text-secondary)' }}>{c.company_name || '—'}</td>
                      ...
                      <td className="px-3 py-1.5 text-xs max-w-xs truncate" style={{ color: 'var(--color-text-secondary)' }}>
                        {c.notes || '—'}
                      </td>
                    </tr>
                  ))}
