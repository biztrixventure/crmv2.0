...
const AcceptInvite = () => {
  ...
  useEffect(() => {
    // Supabase invite/magic-link puts tokens in the URL hash fragment
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || "Failed to set password. The invitation may have expired.");
    } finally {
      setLoading(false);
    }
  };
        ...
        >
          {tokenError ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-bold" style={{ color: "var(--color-text)" }}>Invalid invitation link</h2>
              <p className="text-sm" style={{ color: "var(--color-text-secondary)" }}>
                This invite link is invalid or has expired. Please contact your administrator for a new invitation.
              </p>
              <Link
                to="/login"
            ...
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-bold" style={{ color: "var(--color-text)" }}>Password set!</h2>
              <p className="text-sm" style={{ color: "var(--color-text-secondary)" }}>
            ...
            <div className="flex flex-col items-center gap-3 py-8">
              ...
              <p className="text-sm" style={{ color: "var(--color-text-secondary)" }}>Verifying invitation…</p>
            </div>
          ) : (
            <>
              <div className="mb-6">
                <h2 className="text-xl font-bold" style={{ color: "var(--color-text)" }}>Welcome! Set your password</h2>
