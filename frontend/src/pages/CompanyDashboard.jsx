      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="card p-6">
            <p className="text-sm opacity-75 mb-1">Active Users</p>
            <p className="text-3xl font-bold">0</p>
          </div>
          <div className="card p-6">
            <p className="text-sm opacity-75 mb-1">Active Transfers</p>
            <p className="text-3xl font-bold">0</p>
          </div>
          <div className="card p-6">
        ...
        <div className="card p-6">
          ...
          <p className="opacity-75">Company admin dashboard interface coming soon...</p>
        </div>
      </main>
    </div>
  );
