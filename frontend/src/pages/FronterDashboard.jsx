    ...
    <div className="min-h-screen bg-bg">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="p-6">
            <p className="text-sm text-text-secondary mb-1">Leads Created</p>
            <p className="text-3xl font-bold text-text">0</p>
          </Card>
          <Card className="p-6">
            <p className="text-sm text-text-secondary mb-1">Leads Qualified</p>
            <p className="text-3xl font-bold text-text">0</p>
          </Card>
          <Card className="p-6">
            <p className="text-sm text-text-secondary mb-1">Passed to Closers</p>
            <p className="text-3xl font-bold text-text">0</p>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6">
            <h3 className="text-xl font-bold mb-4 text-text">Create New Lead</h3>
            <p className="text-text-secondary">Lead creation form coming soon...</p>
          </Card>
          <Card className="p-6">
            <h3 className="text-xl font-bold mb-4 text-text">My Leads</h3>
            <p className="text-text-secondary">Your leads list coming soon...</p>
          </Card>
        </div>
      </main>
    </div>
