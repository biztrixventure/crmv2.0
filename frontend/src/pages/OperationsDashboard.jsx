    ...
    <div className="min-h-screen bg-bg">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6">
            <h3 className="text-xl font-bold mb-4 text-text">Operations Queue</h3>
            <p className="text-text-secondary">Operations queue view coming soon...</p>
          </Card>
          <Card className="p-6">
            <h3 className="text-xl font-bold mb-4 text-text">Reports</h3>
            <p className="text-text-secondary">Operations reports coming soon...</p>
          </Card>
        </div>
      </main>
    </div>
