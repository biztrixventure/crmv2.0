    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)" }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="card p-6">
            <p className="text-sm opacity-75 mb-1">Completed</p>
            <p className="text-3xl font-bold">0</p>
          </div>
          <div className="card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="card p-6">
            <h3 className="text-xl font-bold mb-4">Operations Queue</h3>
            <p className="opacity-75">Operations queue view coming soon...</p>
          </div>
          <div className="card p-6">
            <h3 className="text-xl font-bold mb-4">Reports</h3>
            <p className="opacity-75">Operations reports coming soon...</p>
          </div>
        </div>
      </main>
    </div>
